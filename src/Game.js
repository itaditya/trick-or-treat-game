        ...
        {this.state.hasFinished ? (
          <section className="gameover">
            ...
            <div className="twitter-share-button">
              ...
              <a href={`https://twitter.com/intent/tweet?url=https://trick-or-treat.netlify.com&text=I finished the game in ${this.moves} moves.`} target="_blank" title="Share on Twitter">
